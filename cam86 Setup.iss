...
OutputDir="."
OutputBaseFilename="cam86_setup"
Compression=lzma
...
[Files]
Source: "cam86\bin\Release\ASCOM.cam86.Camera.dll"; DestDir: "{app}"
Source: "cam86\bin\Release\FTD2XX_NET.dll"; DestDir: "{app}"
Source: "installer files\cam86ll.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "installer files\readme.txt"; DestDir: "{app}"; Flags: isreadme
Source: "installer files\COPYING"; DestDir: "{app}"
...
begin
  if (CurStep = ssInstall) then // Install step has started
	begin
      ...
      UninstallRegistry := ExpandConstant('Software\Microsoft\Windows\CurrentVersion\Uninstall\("AppId")' + '_is1');
