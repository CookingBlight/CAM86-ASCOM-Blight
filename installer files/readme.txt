21/1/2023 Cam86 ASCOM driver v.0.9.7 Readme

Directory description:
Default installation directory: C:\Program Files (x86)\Common Files\ASCOM\Camera\cam86
FTD2XX_NET.dll  NET interface for FTDI ftd2xx.dll
cam86.dll     cam86 driver, high-level interaction with camera (C++, Visual Studio 2022 project)
...
0.9.7	Made compatible with updated DLL written in C++. Changed calling convention and corrected a few type definitions for compatibility with C++ types.
...
Supported OS: WinXP SP3 x32/x64, Win7 x32/x64, Win8 x32/x64, Win10 x32/x64.
...
Modifications/extensions to the firmware/low-level driver/ASCOM driver- Tommy Ramberg, ramberg.tommy (at) gmail.com
